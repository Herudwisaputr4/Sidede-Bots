                ...
                <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="padding: 10px; border: 1px solid #ddd;">{{ $guru->tempat_lahir }}</td>
                        </tr>

                        <tr>
                            <td style="font-weight: bold; padding: 10px; border: 1px solid #ddd;">Tanggal Lahir</td>
                            <td style="padding: 10px; border: 1px solid #ddd;">{{ \Carbon\Carbon::parse($guru->tanggal_lahir)->format('d-m-Y') }}</td>
                        </tr>
                        <tr>
                            <td style="font-weight: bold; padding: 10px; border: 1px solid #ddd;">Jenis Kelamin</td>
                            <td style="padding: 10px; border: 1px solid #ddd;">{{ $guru->jenis_kelamin }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="padding: 10px; border: 1px solid #ddd;">{{ $guru->status }}</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="padding: 10px; border: 1px solid #ddd;">{{ $guru->email }}</td>
                        </tr>
                    </tbody>
                </table>
